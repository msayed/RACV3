...
namespace RACFlightDataService.Databases.Gaca.Models;

public class FlightDto:IRegister
{
    public Guid Uniquekey { get; set; }
        ...
        public object CargoDetails { get; set; }
        public string AgentInfo { get; set; }
        public int BookedSeats { get; set; }
        public long Id { get; set; }
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<FlightDto, FlightHistory>()
                .Map(dist=>dist.FlightDate,source=>DateTime.Parse( source.OriginDate))
                .Ignore(history => history.Id);
            config.NewConfig<FlightHistory,FlightDto>()
                .Ignore(history => history.Id);
        }
}